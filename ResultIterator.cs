...
namespace Tesseract
{
    public sealed class ResultIterator : PageIterator
    {
        ...
        public float GetConfidence(PageIteratorLevel level)
        {
            ...
            return CsharpTesseract4.Interop.TessApi.Native.ResultIteratorGetConfidence(handle, level);
        }
        ...
        public string GetText(PageIteratorLevel level)
        {
            ...
            return CsharpTesseract4.Interop.TessApi.ResultIteratorGetUTF8Text(handle, level);
        }
        ...
        public FontAttributes GetWordFontAttributes() {
            ...
            IntPtr nameHandle =
                CsharpTesseract4.Interop.TessApi.Native.ResultIteratorWordFontAttributes(
                    handle,
        ...
        public string GetWordRecognitionLanguage()
        {
            ...
            return CsharpTesseract4.Interop.TessApi.ResultIteratorWordRecognitionLanguage(handle);
        }
        ...
        public bool GetWordIsFromDictionary()
        {
            ...
            return CsharpTesseract4.Interop.TessApi.Native.ResultIteratorWordIsFromDictionary(handle);
        }
        ...
        public bool GetWordIsNumeric()
        {
            ...
            return CsharpTesseract4.Interop.TessApi.Native.ResultIteratorWordIsNumeric(handle);
        }
        ...
        public bool GetSymbolIsSuperscript()
        {
            ...
            return CsharpTesseract4.Interop.TessApi.Native.ResultIteratorSymbolIsSuperscript(handle);
        }
        ...
        public bool GetSymbolIsSubscript()
        {
            ...
            return CsharpTesseract4.Interop.TessApi.Native.ResultIteratorSymbolIsSubscript(handle);
        }
        ...
        public bool GetSymbolIsDropcap()
        {
            ...
            return CsharpTesseract4.Interop.TessApi.Native.ResultIteratorSymbolIsDropcap(handle);
        }
        ...
        {
            var choiceIteratorHandle = CsharpTesseract4.Interop.TessApi.Native.ResultIteratorGetChoiceIterator(this.handle);
