    ...
    public sealed class ChoiceIterator : DisposableBase
    {
        ...
        public bool Next()
        {
            ...
            if (_handleRef.Handle == IntPtr.Zero)
                return false;
            return CsharpTesseract4.Interop.TessApi.Native.ChoiceIteratorNext(_handleRef) != 0;
        }
        ...
        public float GetConfidence()
        {
            ...
            return CsharpTesseract4.Interop.TessApi.Native.ChoiceIteratorGetConfidence(_handleRef);
        }
        ...
        public string GetText()
        {
            ...
            return CsharpTesseract4.Interop.TessApi.ChoiceIteratorGetUTF8Text(_handleRef);
        }
        ...
        protected override void Dispose(bool disposing)
        {
            if (_handleRef.Handle != IntPtr.Zero)
            {
                CsharpTesseract4.Interop.TessApi.Native.ChoiceIteratorDelete(_handleRef);
            }
        }
    }
}